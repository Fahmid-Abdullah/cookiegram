...
import { editPost, getPost, newPost } from '../lib/actions/post.actions';
...
export default function page() {
    ...
    const [recipe, setRecipe] = useState('<h2><strong>Ingredients</strong></h2><ul><li></li></ul><h2><strong>Instructions</strong></h2><ul><li></li></ul>');
    ...
    const fetchEditPost = async () => {
        try {
            const postId = params.get('id'); // Ensure `params` is defined
            if (!postId) {
